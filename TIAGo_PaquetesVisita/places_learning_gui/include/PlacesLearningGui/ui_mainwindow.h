...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label->setGeometry(QRect(70, 10, 235, 400));
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "PlacesLearningGui", 0));
        ...
        save_place->setText(QApplication::translate("MainWindow", "Save place", 0));
        save_file->setText(QApplication::translate("MainWindow", "Save file", 0));
        delete_place->setText(QApplication::translate("MainWindow", "Delete place", 0));
