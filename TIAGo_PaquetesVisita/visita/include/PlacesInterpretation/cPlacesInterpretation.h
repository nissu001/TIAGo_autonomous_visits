...
#include "mensajes/Place.h"
#include "mensajes/PlacesVector.h"
#include "mensajes/Pose2DStamped.h"
#include "mensajes/Point2D.h"
#include "mensajes/Room.h"
#include "mensajes/RoomsVector.h"
//#include "servicios/GetRooms.h"
//#include "Place.h"
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
//services
    //bool getRooms(servicios::GetRooms::Request  &req, servicios::GetRooms::Response &res);
  ...
  private:
    ...
    mensajes::RoomsVector known_rooms;
    ...
    //publishers
    mensajes::Pose2DStamped goal;
    ros::Publisher goalPubl;
    int goalPublication(mensajes::Pose2DStamped g);

    mensajes::PlacesVector places;
